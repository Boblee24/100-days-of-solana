...
console.log("Wallet address:", address("HK7eio9SfTPKwzV4AgazUNoArFSDVhoDaAnUVuNq95za"));
...
const { value: balance } = await rpc.getBalance(address("HK7eio9SfTPKwzV4AgazUNoArFSDVhoDaAnUVuNq95za")).send();
